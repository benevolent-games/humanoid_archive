...
import blastDotShader from "../shaders-store/blast-dot-shader.js"

export function createBlastDotTexture(
	...
	Effect.ShadersStore[name+':'+uID+'DiffusePixelShader'] = blastDotShader
